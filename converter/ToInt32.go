...
// ToInt32 converts numeric types to int32.
func (c *Converter[T]) ToInt32(v T) (int32, error) {
	if true == c.IsNil(v) {
		return 0, nil
	}
	...
	default:
		return 0, fmt.Errorf("unsupported type: %T for ToInt32", val)
	}

	if tmpVal < math.MinInt32 || tmpVal > math.MaxInt32 {
